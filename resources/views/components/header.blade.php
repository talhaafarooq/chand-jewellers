    ...
    <div class="header-center-section d-none d-lg-block">
        <div class="container">
            <div class="header-center">
                <div class="logo">
                    <a href="index.html">
                        <img src="{{ URL::asset('website') }}/assets/images/logos/logo.webp" alt="logo">
                    </a>
                </div>
                        ...
                        <div class="cart-submenu">
                            <div class="cart-wrapper-item">
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/product-img/product-img-1.webp"
                                                alt="img">
                                        </div>
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/product-img/product-img-2.webp"
                                                alt="img">
                                        </div>
                                        <div class="wrapper-content">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/product-img/product-img-3.webp"
                                                alt="img">
                                        </div>
                                        <div class="wrapper-content">
                                ...
                                <div class="wrapper">
                                    <div class="wrapper-item">
                                        <div class="wrapper-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/product-img/product-img-4.webp"
                                                alt="img">
                                        </div>
                                        <div class="wrapper-content">
                                ...
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/dresses.webp"
                                                alt="dress">
                                        </span>
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/bags.webp" alt="Bags">
                                        </span>
                                        <span class="dropdown-text">
                                            Bags
                                        </span>
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/sweaters.webp"
                                                alt="sweaters">
                                        </span>
                                        <span class="dropdown-text">
                                            Sweaters
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/shoes.webp"
                                                alt="sweaters">
                                        </span>
                                        <span class="dropdown-text">
                                            Boots
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/gift.webp" alt="gift">
                                        </span>
                                        <span class="dropdown-text">
                                            Gifts
                                        </span>
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/sneakers.webp"
                                                alt="sneakers">
                                        </span>
                                        <span class="dropdown-text">
                                            Sneakers
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/watch.webp"
                                                alt="watch">
                                        </span>
                                        <span class="dropdown-text">
                                            Watches
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/ring.webp" alt="ring">
                                        </span>
                                        <span class="dropdown-text">
                                            Gold Ring
                                        </span>
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/cap.webp" alt="cap">
                                        </span>
                                        <span class="dropdown-text">
                                            Cap
                                        </span>
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/glass.webp"
                                                alt="glass">
                                        </span>
                                        <span class="dropdown-text">
                                            Sunglasses
                        ...
                        <li class="category-list-item">
                            <a href="product-sidebar.html">
                                <div class="dropdown-item d-flex justify-content-between align-items-center">
                                    <div class="dropdown-list-item d-flex">
                                        <span class="dropdown-img">
                                            <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/baby.webp" alt="baby">
                                        </span>
                                        <span class="dropdown-text">
                                            Baby Shop
                                        </span>
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/bags.webp"
                                                    alt="Bags">
                                            </span>
                                            <span class="dropdown-text">
                                                Bags
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/gift.webp"
                                                    alt="gift">
                                            </span>
                                            <span class="dropdown-text">
                                                Gifts
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/ring.webp"
                                                    alt="ring">
                                            </span>
                                            <span class="dropdown-text">
                                                Gold Ring
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/cap.webp"
                                                    alt="cap">
                                            </span>
                                            <span class="dropdown-text">
                                                Cap
                            ...
                            <li class="category-list-item">
                                <a href="product-sidebar.html">
                                    <div class="dropdown-item d-flex justify-content-between align-items-center">
                                        <div class="dropdown-list-item d-flex">
                                            <span class="dropdown-img">
                                                <img src="{{ URL::asset('website') }}/assets/images/homepage-one/category-img/baby.webp"
                                                    alt="baby">
                                            </span>
                                            <span class="dropdown-text">
                                                Baby Shop
                        ...
                        <li class="mega-menu">
                            ...
                            <div class="shop-menu">
                                ...
                                <div class="shop-menu-img">
                                    <img src="{{ URL::asset('website') }}/assets/images/homepage-one/empty-wishlist.webp" alt="img">
                                </div>
                            </div>
                        </li>
                        <li>
