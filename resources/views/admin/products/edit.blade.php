                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            ...
                            {!! Form::model($edit, [
                                'method' => 'PATCH',
                                'action' => ['App\Http\Controllers\Admin\ProductController@update', $edit->id],
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        function findSubCategories(category_id) {
            $.ajax({
        ...
        $(document).ready(function() {
            $('#category').change(function() {
                ...
                if (!category_id) {
                    ...
                    findSubCategories(category_id);
                }
            });
            findSubCategories({{ json_encode($edit->sub_category_id) }});
        });
