                    ...
                    <div class="table-content table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="hiraola-product-remove"><a href="{{ route('website.remove-cart',$product->attributes['slug']) }}"><i class="fa fa-trash"
                                        title="Remove"></i></a>
                                        <input type="hidden" name="slugs[]" value="{{ $product->attributes['slug'] }}">
                                    </td>
                                    ...
                                    <td class="hiraola-product-price"><span class="amount">{{ $settings->currency.number_format($product->price,2) }}</span></td>
                                    <td class="quantity">
                                        <label>Quantity</label>
                                        <div class="cart-plus-minus">
                                            <input class="cart-plus-minus-box" name="qty[]" id="qty" min="1" value="{{ $product->quantity }}" type="text">
                                            <div class="dec qtybutton"><i class="fa fa-angle-down"></i></div>
                                            <div class="inc qtybutton"><i class="fa fa-angle-up"></i></div>
                                        </div>
                                    </td>
                                    <td class="product-subtotal"><span class="amount">{{ $settings->currency.number_format($product->price*$product->quantity,2) }}</span></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
