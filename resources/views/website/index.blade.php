            ...
            <div class="col grid-half grid-md_half order-md-2 order-lg-3">
                <div class="banner-item img-hover_effect">
                    <a href="shop-left-sidebar.html">
                        <img class="img-full" src="{{ URL::asset('website') }}/assets/images/banner/1_1.jpg" alt="Hiraola's Banner">
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-4">
                <div class="banner-item img-hover_effect">
                    <a href="shop-left-sidebar.html">
                        <img class="img-full" src="{{ URL::asset('website') }}/assets/images/banner/1_2.jpg" alt="Hiraola's Banner">
                    </a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="banner-item img-hover_effect">
                    <a href="shop-left-sidebar.html">
                        <img class="img-full" src="{{ URL::asset('website') }}/assets/images/banner/1_3.jpg" alt="Hiraola's Banner">
                    </a>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="banner-item img-hover_effect">
                    <a href="shop-left-sidebar.html">
                        <img class="img-full" src="{{ URL::asset('website') }}/assets/images/banner/1_4.jpg" alt="Hiraola's Banner">
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <div class="single_product">
                            <div class="product-img">
                                <a href="single-product.html">
                                    ...
                                    <img class="secondary-img" src="{{ URL::asset('website') }}/assets/images/product/medium-size/1-1.jpg" alt="Hiraola's Product Image">
                                </a>
                                <span class="sticker-2">Sale</span>
                                <div class="add-actions">
                                    <ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="banner-item img-hover_effect">
                    <a href="shop-left-sidebar.html">
                        <img class="img-full" src="{{ URL::asset('website') }}/assets/images/banner/1_5.jpg" alt="Hiraola's Banner">
                    </a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="banner-item img-hover_effect">
                    <a href="shop-left-sidebar.html">
                        <img class="img-full" src="{{ URL::asset('website') }}/assets/images/banner/1_6.jpg" alt="Hiraola's Banner">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="shipping-nav">
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="shipping-item">
                        <div class="shipping-icon">
                            <img src="{{ URL::asset('website') }}/assets/images/shipping-icon/1.png" alt="Hiraola's Shipping Icon">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="shipping-item">
                        <div class="shipping-icon">
                            <img src="{{ URL::asset('website') }}/assets/images/shipping-icon/2.png" alt="Hiraola's Shipping Icon">
                        </div>
                        <div class="shipping-content">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="shipping-item">
                        <div class="shipping-icon">
                            <img src="{{ URL::asset('website') }}/assets/images/shipping-icon/3.png" alt="Hiraola's Shipping Icon">
                        </div>
                        <div class="shipping-content">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="shipping-item">
                        <div class="shipping-icon">
                            <img src="{{ URL::asset('website') }}/assets/images/shipping-icon/4.png" alt="Hiraola's Shipping Icon">
                        </div>
                        <div class="shipping-content">
