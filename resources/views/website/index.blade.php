                                ...
                                <div class="add-actions">
                                    <ul>
                                        ...
                                        <li><a class="hiraola-add_compare"
                                            ...
                                            data-bs-toggle="tooltip" data-placement="top" title="View Product"><i
                                                class="ion-eye"></i></a>
                                    </li>
                            ...
                            <div class="hiraola-product_content mt-3">
                                <div class="product-desc_info">
                                    <h6>
                                        ...
                                        <a class="product-name" href="{{ route('website.product.details', $product->slug) }}">{{ $product->name }}</a>
                                    </h6>
                                    <div class="price-box">
                                        <span
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="product-tab">
                    <div class="hiraola-tab_title" style="border-bottom: 1px solid #e5e5e5;">
                        <h4>New Products</h4>
                    </div>
