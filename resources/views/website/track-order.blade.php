                ...
                <div class="row mt-4">
                    <div class="col-lg-6 offset-lg-3 col-12">
                        <div class="your-order">
                            ...
                            <h5>Status <span style="float: right;"
                                    class="text-capitalize text-primary">{{ $order->status }}</span></h5>
                                    ...
                                    @if ($status == 'dispatched')
                                            ...
                                            <div class="card-header">
                                                <h5 class="panel-title">
                                                    <a href="javascript:void(0)">
                                                        Tracking No: <span
                                                            style="float: right;color:black;">{{ $trackingNo }}</span>
                                                    </a>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="panel-title">
                                                    <a href="javascript:void(0)">
                                                        Tracking Company: <span
                                                            style="float: right;color:black;">{{ $trackingCompany }}</span>
                                                    </a>
                                                </h5>
                                            </div>
                                        </div>
