                        ...
                        <div class="tab-content myaccount-tab-content" id="account-page-tab-content">
                            ...
                            <div class="tab-pane fade" id="account-details" role="tabpanel"
                                ...
                                <div class="myaccount-details">
                                    <form action="{{ route('website.my-account.update-password') }}" class="hiraola-form"
                                        method="POST">
                                        @csrf
                                        <div class="hiraola-form-inner">
                                            <div class="single-input single-input-half">
                                                <label for="account-details-firstname">First Name*</label>
                                                <input type="text" id="account-details-firstname" name="first_name"
                                            ...
                                            <div class="single-input single-input-half">
                                                ...
                                                <input type="text" id="account-details-lastname" name="last_name"
                                            ...
                                            <div class="single-input">
                                                ...
                                                <input type="text" id="account-details-address" name="address"
                                            ...
                                            <div class="single-input">
                                                ...
                                                <input type="text" id="account-details-cell" name="cell_no"
                                            ...
                                            <div class="single-input">
                                                ...
                                                <input type="text" id="account-details-confpass"
