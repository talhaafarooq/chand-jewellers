                    ...
                    <div class="table-content table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="hiraola-product_remove"><a href="{{ route('website.remove-wishlist-item',$product->product_id) }}"><i class="fa fa-trash"
                                        title="Remove"></i></a></td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="text-danger" align="center"><b>No Item in wishlist...</b></td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
