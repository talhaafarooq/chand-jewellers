    ...
    <div class="container">
        <nav>
            <ol class="cd-breadcrumb" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                ...
                <li class="current"><a href="#">Register New Account</a></li>
            </ol>
        </nav>
    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="password" name="password" id="password" value="{{ old('password') }}"
                                        placeholder="Password" required min="8" max="16">
                                    @error('password')
                                        <font color="red">{{ $message }}</font>
                                    @enderror
                                </div>
                                <div class="col-12">
                                    <label for="terms_conditions">
                                        <input type="checkbox" name="terms_conditions" id="terms_conditions"> I accept all
                                        terms & conditions
                                    </label>
                                </div>
                                ...
                                <div class="text-center mt-3">
                                    <span class="shop-account">Already have an account? <a href="{{ route('login') }}"
                                            class="text-primary">Login Now</a></span>
                                </div>
                            </div>
                        </div>
                    </form>
